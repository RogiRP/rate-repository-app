...
import { render, screen } from "@testing-library/react-native"; // 👈 Importa screen
...
describe("RepositoryList", () => {
  describe("RepositoryListContainer", () => {
    it("renders repository information correctly", () => {
      ...
      // Usamos screen.getAllByTestId en lugar de desestructurar
      ...
      expect(firstItem).toHaveTextContent("88"); // rating
      expect(firstItem).toHaveTextContent("3"); // reviews
